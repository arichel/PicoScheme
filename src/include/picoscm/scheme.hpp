...
public:
    ...
    PortPtr stdin() { return m_stdin; } //!< return a shared-pointer to the default input port
    PortPtr stdout() { return m_stdout; } //!< return a shared-pointer to the default output port
