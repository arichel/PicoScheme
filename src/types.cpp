...
static SymenvPtr topenv{
    new SymenvPtr::element_type{
        ...
        { sym("exact->inexact"), Intern::op_ex2inex },
        { sym("inexact->exact"), Intern::op_inex2ex },
        ...
        { sym("string<?"), Intern::op_isstrlt },
        { sym("string>?"), Intern::op_isstrgt },
        { sym("string<=?"), Intern::op_isstrle },
        { sym("string>=?"), Intern::op_isstrge },
        { sym("string-ci=?"), Intern::op_isstrcieq },
        { sym("string-ci=?"), Intern::op_isstrcieq },
        { sym("string-ci<?"), Intern::op_isstrcilt },
        { sym("string-ci>?"), Intern::op_isstrcigt },
        { sym("string-ci<=?"), Intern::op_isstrcile },
        { sym("string-ci>=?"), Intern::op_isstrcige },
        ...
        { sym("close-port"), Intern::op_close_port },
        { sym("close-input-port"), Intern::op_close_inport },
        { sym("close-output-port"), Intern::op_close_outport },
...
FunctionPtr Scheme::mkfun(const Symbol& sym, function_type&& fn, const SymenvPtr& env)
{
    auto fptr = std::make_shared<FunctionPtr::element_type>(sym, std::move(fn));
    addenv(sym, fptr, env);
    return fptr;
...
void Scheme::repl(std::istream& in, std::ostream& out)
{
    SymenvPtr env = newenv(topenv);
    Parser parser;
    Cell expr;
